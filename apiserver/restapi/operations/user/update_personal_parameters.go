...
func NewUpdatePersonalParams() UpdatePersonalParams {
	...
	return UpdatePersonalParams{}
}

// UpdatePersonalParams contains all the bound params for the update personal operation
...
func (o *UpdatePersonalParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
