...
func NewDeletePersonalParams() DeletePersonalParams {
	...
	return DeletePersonalParams{}
}

// DeletePersonalParams contains all the bound params for the delete personal operation
...
func (o *DeletePersonalParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
