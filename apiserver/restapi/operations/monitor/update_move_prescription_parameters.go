...
func NewUpdateMovePrescriptionParams() UpdateMovePrescriptionParams {
	...
	return UpdateMovePrescriptionParams{}
}

// UpdateMovePrescriptionParams contains all the bound params for the update move prescription operation
...
func (o *UpdateMovePrescriptionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateMovePrescriptionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
