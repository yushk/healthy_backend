...
func (o *UpdateMeasureResultURL) WithBasePath(bp string) *UpdateMeasureResultURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateMeasureResultURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on UpdateMeasureResultURL")
	}
...
func (o *UpdateMeasureResultURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMeasureResultURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMeasureResultURL")
	}
