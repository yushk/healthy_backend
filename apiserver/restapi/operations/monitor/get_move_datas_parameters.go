...
func NewGetMoveDatasParams() GetMoveDatasParams {
	...
	return GetMoveDatasParams{}
}

// GetMoveDatasParams contains all the bound params for the get move datas operation
...
func (o *GetMoveDatasParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetMoveDatasParams) bindQuery(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetMoveDatasParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
