...
func NewUpdateMeasureResultParams() UpdateMeasureResultParams {
	...
	return UpdateMeasureResultParams{}
}

// UpdateMeasureResultParams contains all the bound params for the update measure result operation
...
func (o *UpdateMeasureResultParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateMeasureResultParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
