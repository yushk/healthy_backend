...
func (o *DeleteMeasureDetailURL) WithBasePath(bp string) *DeleteMeasureDetailURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteMeasureDetailURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteMeasureDetailURL")
	}
...
func (o *DeleteMeasureDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteMeasureDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteMeasureDetailURL")
	}
