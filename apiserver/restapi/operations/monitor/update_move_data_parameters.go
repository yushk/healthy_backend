...
func NewUpdateMoveDataParams() UpdateMoveDataParams {
	...
	return UpdateMoveDataParams{}
}

// UpdateMoveDataParams contains all the bound params for the update move data operation
...
func (o *UpdateMoveDataParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
