...
func (o *DeleteMeasureResultURL) WithBasePath(bp string) *DeleteMeasureResultURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteMeasureResultURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/measureResult/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on DeleteMeasureResultURL")
	}
...
func (o *DeleteMeasureResultURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteMeasureResultURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteMeasureResultURL")
	}
