...
func (o *GetMovePrescriptionURL) WithBasePath(bp string) *GetMovePrescriptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetMovePrescriptionURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetMovePrescriptionURL")
	}
...
func (o *GetMovePrescriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMovePrescriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMovePrescriptionURL")
	}
