...
func NewGetCaseDataParams() GetCaseDataParams {
	...
	return GetCaseDataParams{}
}

// GetCaseDataParams contains all the bound params for the get case data operation
...
func (o *GetCaseDataParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
