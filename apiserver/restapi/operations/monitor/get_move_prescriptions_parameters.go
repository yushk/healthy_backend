...
func NewGetMovePrescriptionsParams() GetMovePrescriptionsParams {
	...
	return GetMovePrescriptionsParams{}
}

// GetMovePrescriptionsParams contains all the bound params for the get move prescriptions operation
...
func (o *GetMovePrescriptionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetMovePrescriptionsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetMovePrescriptionsParams) bindQuery(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetMovePrescriptionsParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
