...
func (o *GetMovePrescriptionsURL) WithBasePath(bp string) *GetMovePrescriptionsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetMovePrescriptionsURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/movePrescriptions"
...
func (o *GetMovePrescriptionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMovePrescriptionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMovePrescriptionsURL")
	}
