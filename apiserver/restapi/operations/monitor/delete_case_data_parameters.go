...
func NewDeleteCaseDataParams() DeleteCaseDataParams {
	...
	return DeleteCaseDataParams{}
}

// DeleteCaseDataParams contains all the bound params for the delete case data operation
...
func (o *DeleteCaseDataParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
