...
// DeleteClassParams contains all the bound params for the delete class operation
...
func (o *DeleteClassParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
