...
func NewDeleteWorkParams() DeleteWorkParams {
	...
	return DeleteWorkParams{}
}

// DeleteWorkParams contains all the bound params for the delete work operation
...
func (o *DeleteWorkParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
