...
func NewCreateMeasureResultParams() CreateMeasureResultParams {
	...
	return CreateMeasureResultParams{}
}

// CreateMeasureResultParams contains all the bound params for the create measure result operation
...
func (o *CreateMeasureResultParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
