...
func NewGetWorkSubmitParams() GetWorkSubmitParams {
	...
	return GetWorkSubmitParams{}
}

// GetWorkSubmitParams contains all the bound params for the get work submit operation
...
func (o *GetWorkSubmitParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
