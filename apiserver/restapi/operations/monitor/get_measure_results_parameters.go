...
func NewGetMeasureResultsParams() GetMeasureResultsParams {
	...
	return GetMeasureResultsParams{}
}

// GetMeasureResultsParams contains all the bound params for the get measure results operation
...
func (o *GetMeasureResultsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetMeasureResultsParams) bindQuery(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetMeasureResultsParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
