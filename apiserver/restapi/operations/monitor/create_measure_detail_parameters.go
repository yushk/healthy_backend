...
func NewCreateMeasureDetailParams() CreateMeasureDetailParams {
	...
	return CreateMeasureDetailParams{}
}

// CreateMeasureDetailParams contains all the bound params for the create measure detail operation
...
func (o *CreateMeasureDetailParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
