...
func NewGetMoveDataParams() GetMoveDataParams {
	...
	return GetMoveDataParams{}
}

// GetMoveDataParams contains all the bound params for the get move data operation
...
func (o *GetMoveDataParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
