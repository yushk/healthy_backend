...
func (o *DeleteMovePrescriptionURL) WithBasePath(bp string) *DeleteMovePrescriptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteMovePrescriptionURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/movePrescription/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on DeleteMovePrescriptionURL")
	}
...
func (o *DeleteMovePrescriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteMovePrescriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteMovePrescriptionURL")
	}
