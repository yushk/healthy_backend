...
func NewGetMeasureDetailsParams() GetMeasureDetailsParams {
	...
	return GetMeasureDetailsParams{}
}

// GetMeasureDetailsParams contains all the bound params for the get measure details operation
...
func (o *GetMeasureDetailsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetMeasureDetailsParams) bindQuery(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetMeasureDetailsParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
