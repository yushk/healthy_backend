...
func (fn DeleteMeasureDetailHandlerFunc) Handle(params DeleteMeasureDetailParams, principal *v1.Principal) middleware.Responder {
...
func NewDeleteMeasureDetail(ctx *middleware.Context, handler DeleteMeasureDetailHandler) *DeleteMeasureDetail {
	return &DeleteMeasureDetail{Context: ctx, Handler: handler}
}
...
func (o *DeleteMeasureDetail) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewDeleteMeasureDetailParams()
