...
func (o *GetMoveDatasURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMoveDatasURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMoveDatasURL")
	}
