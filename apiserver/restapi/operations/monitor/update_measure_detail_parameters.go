...
func NewUpdateMeasureDetailParams() UpdateMeasureDetailParams {
	...
	return UpdateMeasureDetailParams{}
}

// UpdateMeasureDetailParams contains all the bound params for the update measure detail operation
...
func (o *UpdateMeasureDetailParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *UpdateMeasureDetailParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
