...
func (o *CreateMovePrescriptionURL) WithBasePath(bp string) *CreateMovePrescriptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateMovePrescriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateMovePrescriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateMovePrescriptionURL")
	}
