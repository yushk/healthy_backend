...
func NewDeleteMovePrescriptionParams() DeleteMovePrescriptionParams {
	...
	return DeleteMovePrescriptionParams{}
}

// DeleteMovePrescriptionParams contains all the bound params for the delete move prescription operation
...
func (o *DeleteMovePrescriptionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteMovePrescriptionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
