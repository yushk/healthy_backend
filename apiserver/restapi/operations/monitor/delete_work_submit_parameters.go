...
func NewDeleteWorkSubmitParams() DeleteWorkSubmitParams {
	...
	return DeleteWorkSubmitParams{}
}

// DeleteWorkSubmitParams contains all the bound params for the delete work submit operation
...
func (o *DeleteWorkSubmitParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
