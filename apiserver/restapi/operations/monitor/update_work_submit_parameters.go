...
func NewUpdateWorkSubmitParams() UpdateWorkSubmitParams {
	...
	return UpdateWorkSubmitParams{}
}

// UpdateWorkSubmitParams contains all the bound params for the update work submit operation
...
func (o *UpdateWorkSubmitParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
