...
func (o *GetWorkSubmitURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on GetWorkSubmitURL")
	}
...
func (o *GetWorkSubmitURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetWorkSubmitURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetWorkSubmitURL")
	}
