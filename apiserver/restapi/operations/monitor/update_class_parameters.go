...
func NewUpdateClassParams() UpdateClassParams {
	...
	return UpdateClassParams{}
}

// UpdateClassParams contains all the bound params for the update class operation
...
func (o *UpdateClassParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
