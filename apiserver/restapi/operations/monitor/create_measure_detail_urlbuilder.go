...
func (o *CreateMeasureDetailURL) WithBasePath(bp string) *CreateMeasureDetailURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateMeasureDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateMeasureDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateMeasureDetailURL")
	}
