...
func (o *CreateMeasureResultURL) WithBasePath(bp string) *CreateMeasureResultURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateMeasureResultURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateMeasureResultURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateMeasureResultURL")
	}
