...
func (o *UpdateMovePrescriptionURL) WithBasePath(bp string) *UpdateMovePrescriptionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateMovePrescriptionURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on UpdateMovePrescriptionURL")
	}
...
func (o *UpdateMovePrescriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMovePrescriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMovePrescriptionURL")
	}
