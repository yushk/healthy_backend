...
func NewGetWorkSubmitsParams() GetWorkSubmitsParams {
	...
	return GetWorkSubmitsParams{}
}

// GetWorkSubmitsParams contains all the bound params for the get work submits operation
...
func (o *GetWorkSubmitsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetWorkSubmitsParams) bindQuery(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetWorkSubmitsParams) bindSkip(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
