...
func NewUpdateCaseDataParams() UpdateCaseDataParams {
	...
	return UpdateCaseDataParams{}
}

// UpdateCaseDataParams contains all the bound params for the update case data operation
...
func (o *UpdateCaseDataParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
