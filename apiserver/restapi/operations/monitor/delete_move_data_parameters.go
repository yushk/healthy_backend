...
func NewDeleteMoveDataParams() DeleteMoveDataParams {
	...
	return DeleteMoveDataParams{}
}

// DeleteMoveDataParams contains all the bound params for the delete move data operation
...
func (o *DeleteMoveDataParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
