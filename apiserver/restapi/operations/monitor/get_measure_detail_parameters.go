...
func NewGetMeasureDetailParams() GetMeasureDetailParams {
	...
	return GetMeasureDetailParams{}
}

// GetMeasureDetailParams contains all the bound params for the get measure detail operation
...
func (o *GetMeasureDetailParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
