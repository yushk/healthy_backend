...
func NewCreateMovePrescriptionParams() CreateMovePrescriptionParams {
	...
	return CreateMovePrescriptionParams{}
}

// CreateMovePrescriptionParams contains all the bound params for the create move prescription operation
...
func (o *CreateMovePrescriptionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
