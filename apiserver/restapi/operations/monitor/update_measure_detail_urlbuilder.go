...
func (o *UpdateMeasureDetailURL) WithBasePath(bp string) *UpdateMeasureDetailURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateMeasureDetailURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/measureDetail/{id}"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on UpdateMeasureDetailURL")
	}
...
func (o *UpdateMeasureDetailURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateMeasureDetailURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateMeasureDetailURL")
	}
